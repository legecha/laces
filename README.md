...
**Note:** During install you'll be asked for your user/pass (email and key) for Flux UI Pro, which you can get from the [Flux UI Dashboard](https://fluxui.dev/dashboard).
